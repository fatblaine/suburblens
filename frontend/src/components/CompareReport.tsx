...
export default function CompareReport({
  ...
  return (
    <div className="bg-white text-[#111] font-sans" style={{ width: widthPx }}>
      {/* Header */}
      ...
      <table className="w-full border-collapse table-fixed">
        ...
        <tbody className="break-inside-avoid">
          ...
          <tr className={ROW}>
            <td className={LABEL}>Index &amp; trend</td>
            {rows.map(r => (
              <td key={r.tenure.salCode} className={VALUE}>
                <span className="font-bold text-[13px]">
                  {r.tenure.residencyShiftIndex ?? '—'}
                </span>
        ...
        <tbody className="break-inside-avoid">
          ...
          {([
            ...
            <tr key={key} className={ROW}>
              ...
              {rows.map(r => (
                <td key={r.tenure.salCode} className={VALUE}>
                  <TenureCell vals={r.tenure.tenure[key]} />
                </td>
              ))}
            </tr>
          ))}
        ...
        <tbody className="break-inside-avoid">
          ...
          <tr className={ROW}>
            <td className={LABEL}>English only</td>
            {rows.map(r => (
              <td key={r.tenure.salCode} className={VALUE}>{fmtPct(englishOnlyPct(r.language))}</td>
            ))}
          </tr>
          <tr className={ROW}>
        ...
        <tbody className="break-inside-avoid">
          ...
          <tr className={ROW}>
            <td className={LABEL}>University-qualified</td>
            {rows.map(r => (
              <td key={r.tenure.salCode} className={VALUE}>
        ...
        <tbody className="break-inside-avoid">
          ...
          <tr className={ROW}>
            <td className={LABEL}>Total incidents</td>
            {rows.map(r => {
